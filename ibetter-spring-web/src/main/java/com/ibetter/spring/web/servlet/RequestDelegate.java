 ...
 */
public class RequestDelegate implements Cloneable{
	
	
	public static final ThreadLocal<RequestDelegate> _requestThreadLocal = new ThreadLocal<RequestDelegate>();
	
	
	private HttpServletRequest request;
	
	{
		_requestThreadLocal.set(this);
	}
	
	public static RequestDelegate getCurrentRequest(){
