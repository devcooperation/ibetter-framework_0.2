package com.ibetter.spring.mybatis.query.support;
...
import com.ibetter.spring.data.query.param.QParam;
import static com.ibetter.spring.mybatis.holder.StmtContextHolder.*;
/** 兼容非接口查询
 * @author zhaojun
